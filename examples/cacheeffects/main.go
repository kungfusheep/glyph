...
func main() {
	...
	children := []Component{
		...
		// skipping Execute: pulse breathes the text warm (a custom effect that
		...
		ScreenEffect(pulse{}, SEVignette().Smooth().Strength(Osc(0.5).Ease(EaseOutBack).Range(0.15, 0.85))),
	}
